...
<h1 align="centre" href="https://polite-coast-05b253e1e.6.azurestaticapps.net/">My Personal Website Built With Azure/<h1>
...
`Python` `PyTorch` `TensorFlow` `Flask` `Django` `SQL` `HTML` `CSS` `JavaScript` `Java` `R`

---

### 🛠️ Developer Tools

`Git` `VS Code` `Azure` `ComfyUI` `Forge` `Ollama` `LM Studio`
